...
def convert_sequences(sequences_path: str | pathlib.Path,
                      tpst_type: str = "offset") -> dict[
    str, TpsOffsetTimeSeries | TpsProfileTimeSeries]:
    """
...
def save_known_sequences(sequences_path: str | pathlib.Path,
...
if __name__ == "__main__":
    # Example usage
    save_known_sequences(sequences_path="known_sequences.pkl",
                         output_path="",
                         save_mode=list,
                         tpst_type="offset")
